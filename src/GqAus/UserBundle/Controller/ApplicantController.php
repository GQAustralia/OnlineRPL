...
class ApplicantController extends Controller {
    ...
    public function searchApplicantsListAction() {
        ...
        $results = $this->get('UserService')->getUserApplicantsList($userId, $userRole, $status, $page, $searchName, $searchTime, $filterByUser, $filterByStatus, $searchAge);
        if ($userRole[0] == Superadmin::ROLE_NAME || $userRole[0] == Manager::ROLE_NAME) {
            $results['facilitators'] = $this->get('UserService')->getUsers(Facilitator::ROLE);
        }
        $qualificationStatus = $this->get('UserService')->getQualificationStatus();
    ...
    public function searchApplicantsListByGridHeadingsAction() {
        ...
        $results = $this->get('UserService')->getUserApplicantsListByGridHeadings($userId, $userRole, $status, $page, $searchName, $searchTime, $filterByFac, $filterByAss, $filterByRto, $filterByStatus);
