...
console.log("dddd");
        ...
        if(reqevt != null){
         files=reqevt.dataTransfer.files;   
            ...
            files = $('#userfiles_browse')[0].files; 
        }
 ...
 \n\
           ...
           //var docType=$('#userfiles_type').val();
            ...
            s3uploads[k] = new S3MultiUpload(file, {user: 'user', pass: 'pass',fileNum: k,docType:docType});
            ...
            s3uploads[k].onUploadCompleted = function(data,obj) {
                ...
                $.ajax({
                    ...
                    success: function(res) {                       
                       ...
                       // $('#myModal').modal('show');
                       $("#idfiles_msg").html('<div class="gq-id-files-upload-success-text" style="display: block;"><h2>File Uploaded successfully!</h2></div>');
                       location.reload();
                    }
                }); 
                def.resolve('success');
