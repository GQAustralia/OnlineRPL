...
$("#frmAddEvidence").ajaxForm({
    ...
    success: function(responseText, statusText, xhr, $form) {
        ...
        if (responseText == '0') {
            ...
            $('#gq-dashboard-tabs-success').html('<h2><img src="' + base_url + 'public/images/tick.png">File size below 10MB are only  upload successfully!</h2>');
        }
    },
    resetForm: true
});
...
$("#frmSelectEvidence").ajaxForm({
    ...
    success: function() {
        ...
        $('.uploadevidence_loader').hide();
        $('#gq-dashboard-tabs-success').show();
        $('#gq-dashboard-tabs-success').html('<h2><img src="' + base_url + 'public/images/tick.png">Existing Evidence uploaded successfully!</h2>');
    },
    resetForm: true
});
    ...
    if (Extension == "gif" || Extension == "png" || Extension == "bmp" || Extension == "jpeg" || Extension == "jpg") {
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result != "error")
                {
                    $("#profile_suc_msg2").html('<div class="gq-id-files-upload-success-text" style="display: block;"><h2><img src=' + base_url + 'public/images/tick.png">Profile Image updated successfully!</h2></div>');
