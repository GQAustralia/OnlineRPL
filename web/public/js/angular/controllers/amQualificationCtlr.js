gqAus.controller('amQualificationCtlr', function ($rootScope, $scope, $window, _, AjaxService, $filter) {
    ...
    $scope.allEvidences = [];
    $scope.evidenceView = {};
	$scope.electiveSubmmited = 0;
	$scope.selectedElectiveUnitsCount = 0;
	$scope.coreSubmmited = 0;
	$scope.selectedCoreUnitsCount = 0;	
        ...
        angular.forEach($scope.userElectiveUnits, function (val, index) {
            if (val.electiveStatus == 1) {
                ...
                if (!_.isEmpty($obj)) {
                    ...
                    $evedenceObject.unViewed = val.unViewed
...
$scope.unitStatusArr['core']['Not Yet Competent'] = [];
        angular.forEach($scope.userCoreUnits, function (val, index) {
                ...
                if (!_.isEmpty($obj)) {
                    ...
                    $coreObject.unViewed = val.unViewed
...
//        });
    ...
    $scope.percentElectiveSubmitted = function () {
		...
		$scope.electiveSubmmited = totalSubmmited;
		$scope.selectedElectiveUnitsCount = $scope.selectedElectiveUnits.length;
    ...
    $scope.percentCoreSubmitted = function () {
		...
		$scope.coreSubmmited = totalSubmmited;
		$scope.selectedCoreUnitsCount = $scope.selectedCoreUnits.length;
