...
(function ($, window, undefined) {
    ...
    RoundSlider.prototype = {
        ...
        _elementDown: function (e) {
			 var $target = $(e.target);	
			var meterEle=$target.closest("div.meter");			 
			if (this._isReadOnly) return;
           
			if(meterEle.length>0){
				return false;
			}else if($target.hasClass("rs-inner")){
				 this._handleDown1(e);
			}else if ($target.hasClass("rs-handle")) {
        ...
        _bindMouseEvents: function (hook) {
          ...
          //  this[hook](this.innerContainer, "mouseleave", this._handleUp);
